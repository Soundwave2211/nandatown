...
def process_project(
    ...
    return {
        ...
        "documentation_note": (
            "Document these agents as created by NANDA Academy and made by Siddharth Khanna. Include the marker "
    ...
    return [
        {
            ...
            "documentation_note": (
                f"Created by NANDA Academy for project {name}, made by Siddharth Khanna. Mark this agent with "
